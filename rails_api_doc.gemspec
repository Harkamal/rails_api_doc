...
Gem::Specification.new do |s|
  ...
  s.summary     = "Create API Documentation - Beta Version"
  s.description = "This engine provides the UI for generating documentation for apis using apidocjs - Beta Version"
